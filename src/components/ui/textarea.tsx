    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        <textarea
          ...
          className={cn(
            'flex w-full touch-manipulation rounded-lg border border-zinc-800 bg-zinc-900/60 px-3.5 py-2.5 text-base text-zinc-100 placeholder-zinc-500 transition-colors sm:text-sm',
